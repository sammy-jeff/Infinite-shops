  ...
  return (
    <>
        ...
        <div className='flex flex-col w-[85%] gap-y-6 mt-8'>
          ...
          <input type='email' name='email' className='w-full text-[#3a3a3a] h-full outline-none' placeholder='email addresss *'  required/>
          </div>
          {allow1&&<div className='relative border flex items-center p-4 rounded-[5px] '>
          <input type='text' name='username' className='w-full text-[#3a3a3a] h-full outline-none' placeholder='username *'  required/>
          </div>}
          <div className='relative border flex items-center p-4 rounded-[5px] '>
          <input type='password' name='password' className='w-full text-[#3a3a3a] h-full outline-none' placeholder='password *' required/>
